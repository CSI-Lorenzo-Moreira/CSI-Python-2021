...
Evaluate the following code. Is the code written correctly? What would be the correct code?
 ...
 - Answer:
           It is not written correctly as it uses apostrophe and quotation marks in an inconsistent manner.  
...
Expected:  The Number is 360
 ...
 - Answer: It is not written correctly as everything inside the parenthesis is a string.
 someNumber: int = 360
